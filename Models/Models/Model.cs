...
namespace Models
{
    public abstract class Model : INotifyDataErrorInfo
    {
        ...
        //ערך הראשון הוא התכונה כמו שם והערך השני הוא רשימה של השיגאות שיש לתכונה זו
        public event EventHandler<DataErrorsChangedEventArgs> ErrorsChanged; //אירוע שגיאה
        private object threadLock = new object(); //אובייקט נעילה 
        private bool isValid; // האם המודל תקין או לא
